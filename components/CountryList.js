      ...
      />
       <View style={styles.infoImage}> 
          <View style={{flexDirection:'row'}}>
            <Image source={require('../assets/images/skull.png')} style={styles.ratingImage}/>
            <Text style={styles.ratingText}>Toplam Ölüm</Text>
          </View>

          <View style={{flexDirection:'row'}}>
            <Image source={require('../assets/images/recover.png')} style={styles.ratingImage2}/>
          ...
          <View style={{flexDirection:'row'}}>
            <Image source={require('../assets/images/add.png')} style={styles.ratingImage2}/>
